...
class TestExpenseAnalysisController {
    ...
    void shouldReturnTotalByCategoryWhenOwner() throws Exception {
        ...
        given(transactionReportUseCase.allTotalSummaryByCategoryAsList(eq(userId), any(), any())).willReturn(List.of());
        ...
        then(transactionReportUseCase).should().allTotalSummaryByCategoryAsList(eq(userId), any(), any());
    }
    ...
    void shouldReturnTotalByDayWhenOwner() throws Exception {
        ...
        given(securityService.isOwner(eq(userId), any(Authentication.class))).willReturn(true);
        given(transactionReportUseCase.allTotalSummaryByDayAsList(eq(userId), any(), any())).willReturn(List.of());
        ...
        then(transactionReportUseCase).should().allTotalSummaryByDayAsList(eq(userId), any(), any());
    }
    ...
    void shouldReturnTotalByMonthWhenOwner() throws Exception {
        ...
        given(securityService.isOwner(eq(userId), any(Authentication.class))).willReturn(true);
        given(transactionReportUseCase.allTotalSummaryByMonthAsList(eq(userId), any(), any())).willReturn(List.of());
        ...
        then(transactionReportUseCase).should().allTotalSummaryByMonthAsList(eq(userId), any(), any());
    }
